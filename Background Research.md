...
The blue boxes shown above represent the I/O to and from the system. The orange boxes represent mechanisms that need to be designed to output each of the intermediate voltages.
